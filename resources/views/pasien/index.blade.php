            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <form class="d-flex align-items-center" action="{{ route('pasien.search') }}"
                            method="GET">
                                    ...
                                    @foreach($dataPasien as $pasien)
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a href="{{ route('pasien.detail', ['id' => $pasien->id]) }}"
                                            ...
                                            <!-- <td class="align-middle">
                                                <a href="{{ route('pasien.screening', ['id' => $pasien->id]) }}"
                                                    class="text-secondary font-weight-bold text-xs"
                                                    data-toggle="tooltip" data-original-title="Lihat screening pasien">
                                                    Lihat Screening
                                                </a>
                                            </td> -->
                                        </tr>
