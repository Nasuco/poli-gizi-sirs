                ...
                <table class="table table-hover align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <td>
                      ...
                      {{-- nambahin if buat ahligizi aja yang bisa liat --}}
                        @if(auth()->user()->type === 'ahligizi')
                        <a href="{{ route('screening.delete', ['id' => $screening->id_screening]) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Hapus screening">
                          Hapus
                        </a>
                        @endif
