            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h6 class="text-body mb-0">Hasil Pencarian</h6>
                        
                        <form class="d-flex align-items-center" action="{{ route('kitchen.search') }}" method="GET">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <a href="{{ route('kitchen.detail', ['id' => $pasien->id]) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Detail pasien">
                                                Detail
                                            </a>
                                        </td>
                                    </tr>
